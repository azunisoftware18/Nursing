...
function Home() {
  ...
  const statsData = [
    {
      ...
      description:
        "Admission Guidance & Personal Support to 2000+ Nursing College in India.",
    },
    {
      number: "35 K+",
      label: "Students",
      description:
        "We are Serving more than 35K + Students every Academic Year.",
    },
    {
      number: "4 +",
      label: "Courses",
      description:
        "Admission Guidance for B.SC, M.SC, (P)B.SC, GNM - Nursing Courses",
    },
    {
      number: "24 +",
      label: "Universities",
      description:
        "A wide range of Universities are offering various Nursing Courses in India.",
    },
  ];
    ...
    <div className="relative min-h-screen  w-full bg-gradient-to-br from-purple-50 via-white to-blue-50 overflow-y-auto lg:overflow-hidden flex flex-col">
      ...
      <div className="relative w-full max-w-7xl mx-auto px-4 sm:px-10 lg:px-12 flex-1 flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-12 py-16 lg:py-0">
        ...
        <div className="w-full lg:w-[55%] z-20 text-center lg:text-left flex flex-col justify-center order-2 lg:order-1">
          <h1 className="text-3xl sm:text-4xl md:text-5xl xl:text-6xl font-extrabold leading-tight lg:leading-[1.1] mb-4">
            Find The <br />
          ...
          <p className="text-gray-500 text-sm md:text-base lg:text-lg mb-6 max-w-lg mx-auto lg:mx-0 px-2">
            Discover top-rated nursing institutions and kickstart your medical
            career today.
          </p>
          ...
          <div className="mt-8 text-[11px] md:text-xs text-gray-400">
            ...
            <div className="inline-flex flex-wrap justify-center lg:justify-start gap-2 mt-2 lg:mt-0">
              <span className="hover:text-[#11B1CC] cursor-pointer underline decoration-purple-100">
                Kerala
              </span>
              ,
              <span className="hover:text-[#11B1CC] cursor-pointer underline decoration-purple-100">
  ...
  max-h-[40vh] sm:max-h-[50vh] lg:max-h-[99vh]
  ...
  hover:scale-105 hover:-translate-y-2"
      ...
      <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-[0] transform rotate-180 z-30">
        <svg
          ...
          className="relative block w-full h-[40px] md:h-[60px] lg:h-[70px] fill-white"
        >
