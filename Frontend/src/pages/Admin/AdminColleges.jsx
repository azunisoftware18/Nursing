      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden flex flex-col min-h-[500px]">
        {isLoading ? (
          ...
          <>
                ...
                <div key={college.id} className="p-4 border-b border-gray-100 hover:bg-gray-50/50">
                  ...
                  <div className="grid grid-cols-2 gap-2 text-sm">
                    ...
                    <div>
                      ...
                      <span
                        className={`text-[10px] px-2.5 py-1 rounded-full font-black uppercase tracking-tighter inline-block ${college.sector === "Government"
                ...
                <tbody className="divide-y divide-gray-50">
                  {paginatedColleges.map((college) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4 text-sm text-gray-600 font-medium truncate max-w-[150px]">
                        {college.city}, {college.state}
                      </td>
                      <td className="px-6 py-4">
                        <span
            ...
            {!isLoading && colleges?.message && filteredColleges.length === 0 && (
